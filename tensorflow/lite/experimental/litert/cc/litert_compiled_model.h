...
class CompiledModel
 ...
 public:
  ...
  // returned CompiledModel object. The caller should keep the model alive until
  // the CompiledModel is destroyed. Note that compilation options are
  // applicable only for on-device compilation.
  //
