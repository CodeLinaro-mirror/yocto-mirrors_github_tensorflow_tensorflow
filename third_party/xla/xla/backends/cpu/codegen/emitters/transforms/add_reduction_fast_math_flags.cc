  ...
  mlir::LogicalResult matchAndRewrite(
    ...
    callee->walk([&rewriter](mlir::Operation* op) {
      if (auto fm_op =
        ...
        ma::FastMathFlagsAttr current_fm_flags = fm_op.getFastMathFlagsAttr();
        ma::FastMathFlagsAttr new_fm_flags =
            rewriter.getAttr<ma::FastMathFlagsAttr>(
                current_fm_flags.getValue() | ma::FastMathFlags::reassoc);
