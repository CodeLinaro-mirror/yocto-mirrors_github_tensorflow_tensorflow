...
#include "mlir/Dialect/Func/IR/FuncOps.h"  // IYU pragma: keep, passes.h.inc
#include "mlir/IR/OpDefinition.h"
#include "mlir/IR/Operation.h"
#include "mlir/IR/Region.h"
#include "mlir/IR/Value.h"
#include "mlir/Pass/Pass.h"  // IYU pragma: keep, passes.h.inc
...
class SinkConstantsToControlFlowPass
  ...
  void runOnOperation() override {
    getOperation().walk([](Operation* op) {
      // Skip StableHLO WhileOp, the HLO lowering converts captured constants to
      // input parameters which results in better performance.
      if (llvm::isa<stablehlo::WhileOp>(op)) return;
