...
std::string ToString(const OutputTilingInfo& output_tiling_info,
                     const absl::string_view field_separator = "\n") {
  return absl::StrCat(
      "num_output_tiles_per_dim: ",
      output_tiling_info.num_output_tiles_per_dim.size(), field_separator,
      absl::StrJoin(output_tiling_info.num_output_tiles_per_dim, ", "),
      field_separator, "output_tile_offset_indexing: ",
      ToString(output_tiling_info.output_tile_offset_indexing), field_separator,
      "linear_output_tile_offset_indexing: ",
      ToString(output_tiling_info.linear_output_tile_offset_indexing));
}
...
// tiled instruction and offset tiling of the output.
...
// of the instruction.
// May insert new instructions into `tiled_hlo_instructions_set`, they are
// returned in `new_instructions`.
