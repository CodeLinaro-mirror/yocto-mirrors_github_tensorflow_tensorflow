...
TEST(BlockLevelParametersTest,
  ...
  RootTileSizes root;
  root.mutable_output_tile_sizes()->Add(18);
  root.mutable_output_tile_sizes()->Add(19);
  *block_level_fusion_config.add_roots() = root;
...
TEST(BlockLevelParametersTest,
  ...
  EXPECT_EQ(block_level_fusion_config.roots_size(), 1);
  EXPECT_THAT(block_level_fusion_config.roots(0).output_tile_sizes(),
              ElementsAre(18, 19));
