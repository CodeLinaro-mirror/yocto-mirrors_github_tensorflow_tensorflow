"""Build rules for XLA testing. This file is only used for the OSS build and running tests on github.
"""
...
def xla_test(
    ...
    This rule is similar to platforms/.../build_defs.bzl but only meant for running the tests on github.
