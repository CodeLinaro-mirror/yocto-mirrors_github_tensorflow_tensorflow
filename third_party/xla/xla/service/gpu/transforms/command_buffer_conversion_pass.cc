...
absl::StatusOr<bool> CommandBufferConversionPass::IsConvertible(
    const Thunk& thunk, const CommandBufferConfig& config) {
...
absl::StatusOr<bool> CommandBufferConversionPass::Run(
  ...
  std::vector<std::unique_ptr<Thunk>> original_thunks =
