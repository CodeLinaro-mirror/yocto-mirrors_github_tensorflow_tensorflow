...
// CHECK-LABEL: func @skip_sink_const_to_while
func.func @skip_sink_const_to_while(%arg0: tensor<i64>) -> tensor<i64> {
  // CHECK: %[[C0:.+]] = stablehlo.constant dense<1> : tensor<i64>
  // CHECK-DAG: %[[C1:.+]] = stablehlo.constant dense<2> : tensor<i64>
