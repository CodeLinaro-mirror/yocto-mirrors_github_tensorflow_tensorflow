...
StaticRangePtqComponent::StaticRangePtqComponent(
  ...
  sub_components_[1] =
      std::make_unique<tf_quant::stablehlo::CalibrationComponent>(
  ...
  sub_components_[2] =
      std::make_unique<tf_quant::stablehlo::PostCalibrationComponent>(ctx_);
}
...
absl::Status QuantizeStaticRangePtq(
  ...
  absl::StatusOr<absl::flat_hash_map<FunctionName, FunctionAlias>>
      function_aliases =
          tf_quant::stablehlo::GetFunctionAliases(src_saved_model_path, tags);
  ...
  TF_ASSIGN_OR_RETURN(
      ...
      tf_quant::stablehlo::ImportSavedModel(
  ...
  TF_ASSIGN_OR_RETURN(const ExportedModel post_calibrated_exported_model,
                      tf_quant::stablehlo::CreateExportedModel(
                          signature_keys, tags, quantization_config,
                          tf_quant::stablehlo::PostCalibrationComponent::kName,
                          *function_aliases, *ctx, *module));
