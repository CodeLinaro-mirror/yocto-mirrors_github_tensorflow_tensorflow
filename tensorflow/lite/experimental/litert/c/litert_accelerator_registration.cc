...
LiteRtStatus LiteRtCreateAccelerator(LiteRtAccelerator* accelerator) {
  ...
  *accelerator =
      litert::internal::LiteRtAcceleratorRegistry::CreateEmptyAccelerator()
          .release();
  return kLiteRtStatusOk;
}

LiteRtStatus LiteRtDestroyAccelerator(LiteRtAccelerator accelerator) {
  litert::internal::LiteRtAcceleratorRegistry::DestroyAccelerator(accelerator);
  return kLiteRtStatusOk;
}
...
LiteRtStatus LiteRtRegisterAccelerator(LiteRtAccelerator accelerator,
  ...
  litert::internal::LiteRtAcceleratorRegistry::Ptr accelerator_guard(
      accelerator);
