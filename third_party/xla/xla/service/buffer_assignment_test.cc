...
TEST(ComputePeakMemoryTest, SimpleAllocation) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 10);
}
...
TEST(ComputePeakMemoryTest, PaddedAllocation) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 64);
}
...
TEST(ComputePeakMemoryTest, MultipleBuffersSomePadded) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 84);
}
...
TEST(ComputePeakMemoryTest, MultipleBuffers) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 60);
}
...
TEST(ComputePeakMemoryTest, SharedBuffers) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 20);
}
...
TEST(ComputePeakMemoryTest, SharedChain) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 310);
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 4000);
}
...
TEST(ComputePeakMemoryTest, SharingAllocatesBuffers) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 200);
}
...
TEST(ComputePeakMemoryTest, EmptyProto) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 0);
}
...
TEST(ComputePeakMemoryTest, MultipleAssignments) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 333);
}
...
TEST(ComputePeakMemoryTest, ShareParameter) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 1024);
}
...
TEST(ComputePeakMemoryTest, ParamBufferAndAllocationBuffer) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 123 + 321);
}
...
TEST(ComputePeakMemoryTest, LargeResult) {
  ...
  EXPECT_EQ(ComputePeakMemory(proto).ValueOrDie(), 1LL << 33);
}
