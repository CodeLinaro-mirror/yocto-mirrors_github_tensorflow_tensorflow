...
#include "xla/backends/cpu/codegen/concatinate_kernel_emitter.h"
...
ConcatinateKernelEmitter::ConcatinateKernelEmitter(
...
ConcatinateKernelEmitter::EmitKernelDefinition() {
