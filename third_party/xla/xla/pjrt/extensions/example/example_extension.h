...
struct PJRT_ExampleExtension_GetExampleExtensionCpp_Args;
...
typedef struct PJRT_Example_Extension {
  ...
  PJRT_Error* (*get_example_extension_cpp)(
      PJRT_ExampleExtension_GetExampleExtensionCpp_Args* args);
} PJRT_Example_Extension;
PJRT_DEFINE_STRUCT_TRAITS(PJRT_Example_Extension, get_example_extension_cpp);
...
typedef struct PJRT_ExampleExtension_GetExampleExtensionCpp_Args {
  PJRT_ExampleExtensionCpp extension_cpp;
} PJRT_ExampleExtension_GetExampleExtensionCpp_Args;
PJRT_DEFINE_STRUCT_TRAITS(PJRT_ExampleExtension_GetExampleExtensionCpp_Args,
                          extension_cpp);

typedef PJRT_Error*(
    PJRT_GetExampleExtensionCpp_Fn)(PJRT_ExampleExtension_GetExampleExtensionCpp_Args*);  // NOLINT(whitespace/line_length)
...
PJRT_Example_Extension CreateExampleExtension(
    ...
    PJRT_GetExampleExtensionCpp_Fn get_example_extension_cpp);
