...
TEST_F(SymbolicTileTest, CanPropagateTileThroughReverseOfCombiningReshape) {
  // A reverse of a combining reshape creates a negative unit stride atop a
  // multivariate tile. We start off with this indexing map:
  // (d0, d1, d2, d3) -> (d0 * 24 - d1 * 6 - d2 + 23, d3),
