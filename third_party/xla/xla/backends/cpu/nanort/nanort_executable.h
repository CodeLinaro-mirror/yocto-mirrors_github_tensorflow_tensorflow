 ...
 public:
  ...
  class ExecuteOptions {
   public:
    ...
    ExecuteOptions& set_local_device_ordinal(int32_t local_device_ordinal);
    ExecuteOptions& set_global_device_ordinal(int32_t global_device_ordinal);
    ...
    int32_t local_device_ordinal() const { return local_device_ordinal_; }
    int32_t global_device_ordinal() const { return global_device_ordinal_; }
   ...
   private:
    ...
    int32_t global_device_ordinal_;
