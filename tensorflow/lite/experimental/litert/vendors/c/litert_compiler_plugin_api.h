...
typedef LiteRtStatus (*LiteRtCompiledResultNumByteCodeT)(
...
struct LiteRtCompilerPluginApi {
  ...
  LiteRtCompiledResultNumByteCodeT get_compiled_result_num_byte_code;
...
static constexpr absl::string_view kLiteRtCompiledResultNumByteCode =
    "LiteRtCompiledResultNumByteCode";
