...
absl::StatusOr<TritonWrapperResult> CompileTritonToLLVM(
  ...
  LoggingIRPrinterConfig::EnableLoggingIfRequested(
      pm, &mlir_context, hlo_module, kernel_name, "triton-to-llvm");
...
absl::Status LowerXTileToTriton(mlir::ModuleOp xtile_dialect_module,
                                ...
                                const se::DeviceDescription& device_info) {
  {
    ...
    mlir::PassManager pm(&mlir_context);
    LoggingIRPrinterConfig::EnableLoggingIfRequested(
        pm, &mlir_context, hlo_module, fusion.name(), "xtile-to-triton");
...

  {
    if (fusion.GetModule()
      ...
      mlir::PassManager pm(&mlir_context);
      LoggingIRPrinterConfig::EnableLoggingIfRequested(
          pm, &mlir_context, *fusion.GetModule(), fusion.name(),
