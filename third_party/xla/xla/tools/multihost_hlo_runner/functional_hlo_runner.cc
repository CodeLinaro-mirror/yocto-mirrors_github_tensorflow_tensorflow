...
const FixedOptionsFlagParser<InputFormat>& GetInputFormatParser() {
  static const auto& parser = GetFixedOptionsFlagParser<InputFormat>(
...
const FixedOptionsFlagParser<OutputFormat>& GetOutputFormatParser() {
  static const auto& parser = GetFixedOptionsFlagParser<OutputFormat>(
...
const FixedOptionsFlagParser<FunctionalHloRunner::ModuleArgumentMode>&
GetModuleArgumentModeParser() {
  using ModuleArgumentMode = FunctionalHloRunner::ModuleArgumentMode;
  static const auto& parser = GetFixedOptionsFlagParser<ModuleArgumentMode>(
...
const FixedOptionsFlagParser<FunctionalHloRunner::ModuleOutputMode>&
GetModuleOutputModeParser() {
  using ModuleOutputMode = FunctionalHloRunner::ModuleOutputMode;
  static const auto& parser = GetFixedOptionsFlagParser<ModuleOutputMode>(
