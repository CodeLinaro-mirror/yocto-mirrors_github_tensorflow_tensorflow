...
def workspace():
    ...
    if "rules_ml_toolchain" not in native.existing_rules():
        http_archive(
            ...
            sha256 = "eb04544e297bc1387f37b1b38c8e75b0ca65fdd831f88adb23ab0c34d6ed4d53",
            strip_prefix = "rules_ml_toolchain-3f998beb8b6eaaf98183bcf7adebb62d1c659b6c",
            urls = [
                "https://github.com/google-ml-infra/rules_ml_toolchain/archive/3f998beb8b6eaaf98183bcf7adebb62d1c659b6c.tar.gz",
            ],
        )
