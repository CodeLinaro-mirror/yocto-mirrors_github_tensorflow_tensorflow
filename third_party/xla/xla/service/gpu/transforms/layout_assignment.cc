...
bool GpuLayoutAssignment::PropagateReductionLayoutToOperand(
  ...
  // TODO: b/466059465 - The following compares unnested reductions against
  // elemental reductions. Change this to compare unnested row reductions
  // against *any* other reduction that does not require layout propagation,
  // in particular, unnested column reductions.
