...
std::unique_ptr<KernelArgsPackedArrayBase> PackKernelArgs(
    absl::Span<std::variant<DeviceMemoryBase, TensorMap>> args,
    uint32_t shared_mem_bytes) {
  auto ContainsTensorMap =
      [](absl::Span<std::variant<DeviceMemoryBase, TensorMap>> args) -> bool {
...
PackKernelArgs(absl::Span<std::variant<DeviceMemoryBase, TensorMap>> args,
               uint32_t shared_mem_bytes) {
