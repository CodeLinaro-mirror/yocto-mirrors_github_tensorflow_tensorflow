...
def workspace():
    ...
    http_archive(
        ...
        sha256 = "032525b3a6eeb37d9e3c67510ecdd7d70fe2a7bca279df3d58abfb7e350a0770",
        strip_prefix = "rules_ml_toolchain-0e8452589a3a316717a8bf01011c25c9a3a8ca8f",
        urls = [
            "https://github.com/google-ml-infra/rules_ml_toolchain/archive/0e8452589a3a316717a8bf01011c25c9a3a8ca8f.tar.gz",
        ],
    )
